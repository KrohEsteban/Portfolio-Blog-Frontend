    ...
    <>
      <div className=''>
        <div className='min-h-[90vh] border-b p-2 pt-5 border-solid border-gris-claro mb-10 font-dancingscript '>
            ...
            <Image src='/perfil.webp' blurDataURL='/perfil.webp' alt='Esteban Kroh, programador web, foto de perfil.'
              height={200}
              width={200}
              placeholder="blur"
